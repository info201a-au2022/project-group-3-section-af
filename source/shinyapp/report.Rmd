...
While nationwide data appears to be a huge problem in the United States, there is more importance in 
how the various communities of each state interacts with one another. When evaluating the situation among the bigger cities, it is crucial to identify what cultural insecurities the community is divided by. Many of these communities can be influenced by nearby events or popular outrages across the nation, such as the attack against their own racial community, or even the interactions between gang violence endangering the neighboring community. Furthermore, the unevenly distributed diversity among these communities share a different stance of power between the people. In some occurrences, groups that are targeted to have a higher toll in arrests and casualties appear to be targeted more often, sharing a stigma of how those not belonging to the majority are therefore in the wrong. This even spreads out to the social status between how male and females are meant to interact in the world. As the trend of male targets being associated with criminal activity, future reports will more likely lean towards the female's side of the story as opposed to the male in the case of both genders sharing conflict against each other. This can also be influenced with the cultural premise of these communities, where crime is tolerated more so than others, especially in incentivising the male audience to enact these crimes. Furthermore, the allowance of weaponry in raising the individual's control of power strengthens the appearance of violence overall. Areas that support firearms, and has laws in making the weapons more accessible appears to be the common method in how these criminal activities are engaged and end.

## Conclusion

The United States contains a divided, biased vision in how violence is treated between the communities and their respective police force. Both gender and race are identified to be targeted factors in the outcome of violence, which continues to play around the security of the nation and the deciding factor in people's fate. Political and other social values inhibit a force of change in the appearance of violence. Gender continues to be a glamorized  factor in how people assume the dangerous people in a particular situation, with the control of lethal weapons in the citizen's hands and the police's hands giving opportunities for light conflict to deescalate into tragedies.

The climate in the United States is continuously proactive in these divisions. The treatment against racial groups has been persistence over the past centuries, with the call-to-action movements becoming visibly more common. As these social movements and new political figures arise to resolve these issues, it is important to stay informed with accurate visions of the communities around rather than speculating the biased messages being spread around the nation. By focusing on the specific details of the needs in our community, we can strive to change the nation into becoming a more protective, civil, responsible country.
